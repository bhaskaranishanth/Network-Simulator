...
REMOVE_FROM_BUFFER = "REMOVE_FROM_BUFFER"

type_events = [TIMEOUT_EVENT, LINK_TO_ENDPOINT, PACKET_RECEIVED, DYNAMIC_ROUTING, ROUTING_PACKET_RECEIVED, UPDATE_WINDOW, GRAPH_EVENT, REMOVE_FROM_BUFFER]
